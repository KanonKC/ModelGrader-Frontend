...
export async function deleteCollection(collection_id) {
	return axios.delete(`${URL}/api/collections/${collection_id}`);
}
...
export async function addCollectionProblem(collection_id, problem_ids) {
	return axios.put(`${URL}/api/collections/${collection_id}/problems/add`, {
...
export async function removeCollectionProblem(collection_id, problem_ids) {
	return axios.put(
		`${URL}/api/collections/${collection_id}/problems/remove`,
		{
			problem_ids: problem_ids,
		}
	);
