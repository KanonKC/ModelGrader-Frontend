...
export function submitProblem(id,code){
    ...
    return axios.post(`${URL}/api/problems/${id}/${localStorage.getItem("account_id")}`,body)
}

export function viewAllSubmissions({account_id,problem_id,passed,sort_date,sort_score}){
    let query = '?'
