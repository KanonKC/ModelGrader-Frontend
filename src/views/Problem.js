	...
	return (
		<Container>
			<div className="problem-views">
				...
				>
					<p>
						<b className="text-orange-500">P (Passed)</b> -
						โค้ดทำงานได้ และได้คำตอบที่ถูกต้อง
					</p>
					<p>
						<b className="text-orange-500">- (Failed)</b> -
						โค้ดทำงานได้ แต่ให้คำตอบที่ผิด
						ตรวจสอบให้แน่ใจว่าไม่มีตัวอักษรตัวไหนตกหล่น
						หรือพิมพ์ผิดไป และเข้าใจโจทย์อย่างถูกต้อง
					</p>
					<p>
						<b className="text-orange-500">E (Error)</b> -
						โค้ดเกิดการ Error ระหว่างทำงาน
						ลองตรวจสอบความถูกต้องของโค้ดใหม่
					</p>
					<p>
